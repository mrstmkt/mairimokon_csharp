...
{
    public partial class MaiRPanel2View : UserControl, IMaiRPanel
    {
        public MaiRControlValue.PanelType Type
        {
            get
            {
                return MaiRControlValue.PanelType.Type2;
            }
        }
        ...
        public MaiRPanel2View()
            : this(null)
        {
//            this.buttonItems = new List<IMaiRButton>();
        }
        public MaiRPanel2View(MainForm main)
        {
            InitializeComponent();
