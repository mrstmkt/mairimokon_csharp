...
{
    public partial class MaiRPanel1View : UserControl, IMaiRPanel
    {
        public MaiRControlValue.PanelType Type
        {
            get
            {
                return MaiRControlValue.PanelType.Type1;
            }
        }
        ...
        public MaiRPanel1View():this(null)
        {
//            this.buttonItems = new List<IMaiRButton>();
        }

        public MaiRPanel1View(MainForm main)
        {
            InitializeComponent();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (this.MainForm != null)
            {
                if (this.Selected == true)
                {
                    ...
                    g.DrawRectangle(p, 0, 0, this.topDownFlowLayoutPanel.Width, this.topDownFlowLayoutPanel.Height);
                }
            }
        }
