...
{
    public partial class MaiRPanel3View : UserControl, IMaiRPanel
    {
        public MaiRControlValue.PanelType Type
        {
            get
            {
                return MaiRControlValue.PanelType.Type3;
            }
        }
        ...
        public MaiRPanel3View()
            : this(null)
        {
//            this.buttonItems = new List<IMaiRButton>();
        }
        public MaiRPanel3View(MainForm main)
        {
            InitializeComponent();
            ...
            this.ButtonItems.Add(this.button1_4);
            ...
            this.ButtonItems.Add(this.button7_1);
            this.ButtonItems.Add(this.button7_2);
            this.ButtonItems.Add(this.button7_3);
            this.MainForm = main;
        }
        ...
        {
            TopDownFlowLayoutPanel_Click(sender, e);
        }
